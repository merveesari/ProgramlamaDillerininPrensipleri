    ...
    public static void main(String[] args) {
        try{
            ...
            do {
                ...
                if (Pattern.matches(".*[a-zA-Z]+.*[a-zA-Z]",data)) { //Satırları boşluğa göre kelime olarak dizi şeklinde tutan Kelime dizisinin eleman sayısının Kelimesayaca'a eklenmesi. Satır satır okuma yaptığımız her satırdaki kelimeleri topladık.
                    KelimeSayac += Kelime.length;
                }
