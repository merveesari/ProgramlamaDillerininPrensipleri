        ...
        do{ //Çıkış işlemi seçilene kadar programın devam etmesi için koşullu döngü
            ...
            switch(sec){ //Menüden seçilen işleme göre gerekli işlemlerin gerçekleştirilmesi
                case 1:
                    ...
                    for (int i = 0; i < KisiSayi; i++) { //Rastgele kisi oluşturarak kişilerin bilgilerini dosyaya yazdırma
                ...
                case 2:
                    try{
                        ...
                        do{ //Kisiler.txt dosyasının satırlarının boşluğa göre kelimelere ayrılarak her bir satırdaki kimlik ve IMEI numaralarının ilgili dizilere atanması
                            data = myReader.nextLine();

                            Kelime = data.split(" ");//kelimelere ayır
